...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('traumatismo', function (Blueprint $table){
            $table->increments('idTraumatismo');
            $table->string('traumatismo_causa');
            $table->string('traumatismo_fecha');
            $table->string('traumatismo_secuela');
            $table->string('traumatismo_tipo');
